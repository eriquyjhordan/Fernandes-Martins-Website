    ...
    <header className="bg-header w-full relative py-9 md:pb-16">
      <div className="2xl:mx-28">
        ...
        <div className="mx-4 sm:mx-6 mt-16 sm:ml-[112px] sm:max-w-[1200px]">
          ...
          <p className="text-white text-base mt-6 font-extralight sm:max-w-[370px]">
            Estamos prontos para te oferecer soluções jurídicas eficientes. Faça
          ...
          <div className="mt-6 flex relative lg:max-w-[800px] xl:max-w-[980px] mr-6">
            ...
            />
            <button
              className={`bg-[#AB8768] z-50 text-xs text-white h-full pl-6 pr-5 sm:px-16 py-2 rounded-tr-[64px] rounded-br-[64px] rounded-bl-[150px] absolute top-0 right-0 ${
                message.length === 0
